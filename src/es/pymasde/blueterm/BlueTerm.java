...
public class BlueTerm extends Activity implements TextToSpeech.OnInitListener{
...
*/                
            ...
            case MESSAGE_READ:
            	  String s=msg.getData().getString("dat");
            	char c;
            	if(s.length()>1){
            		
            		//Toast.makeText(getApplicationContext(), s+s.length(), 100).show();	
        ...
        for (int i = 0; i < length; i++) {
            ...
            try {
                if (BlueTerm.LOG_CHARACTERS_FLAG) {
                   ...
                   // Toast.makeText((Context) getBaseContext(), printableB,10).show();
                    if (b < 32 || b > 126) {
                        printableB = ' ';
                    }
